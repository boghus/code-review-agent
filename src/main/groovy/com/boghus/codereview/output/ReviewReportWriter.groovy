...
class ReviewReportWriter {
    ...
    void write(String outputPath, String body) {
        String disclaimer = """\n> ⚠️ **AI-generated review:** This review was generated by an AI model and may contain **false positives, false negatives, or incorrect recommendations**. Please validate the findings before making changes.\n"""
        String version = actionRef ? "\n---\n🤖 Code Review Agent\nVersion: ${actionRef}\n" : ''
        String commit = actionSha ? "Commit: ${actionSha}\n" : ''
        new File(outputPath).write("${COMMENT_MARKER}\n${body}\n${disclaimer}${version}${commit}", 'UTF-8')
    }
